...
const TIMELINE_DATA = [
  {
    ...
    org: "Systems Limited",
    description: "Conducted rigorous testing and quality assurance for enterprise applications. Gained hands-on experience in manual and automated testing methodologies.",
    type: "work",
  },
  {
  ...
  },
  {
    ...
    description: "Designed intuitive user interfaces and experiences for web and mobile platforms. Collaborated with developers to ensure faithful implementation of designs using Figma.",
    type: "work",
  },
  {
    ...
    org: "Mind Digital",
    description: "Developed responsive websites using React and Tailwind CSS. Assigned to optimize web performance and ensure cross-browser compatibility.",
    type: "work",
  },
  {
    year: "2021 - 2025",
    ...
    org: "Iqra University",
    description: "Completed Bachelor of Science in Software Engineering. Published research in Explainable AI and TinyML. Final Year Project: 'IQRAversity' - a VR campus tour.",
    type: "education",
  },
];
