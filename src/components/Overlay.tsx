    ...
    <div className="absolute inset-0 pointer-events-none z-10 flex flex-col justify-center text-white mix-blend-difference">
        ...
        >
            <div className="text-center">
                <h1 className="text-6xl md:text-8xl font-bold tracking-tight mb-4">Dheeraj Kumar.</h1>
                <p className="text-xl md:text-2xl font-light text-gray-300">Software Engineer & AI Researcher.</p>
            </div>
        </motion.div>
        ...
        >
            <div className="max-w-2xl">
                <h2 className="text-5xl md:text-7xl font-bold leading-tight">Creating intelligent <br/><span className="text-blue-500">AI Systems</span> & modern web apps.</h2>
            </div>
        </motion.div>
        ...
        >
            <div className="max-w-2xl">
                <h2 className="text-5xl md:text-7xl font-bold leading-tight">Expertise in Next.js, <br/><span className="text-purple-500">Python</span> & Machine Learning.</h2>
            </div>
        </motion.div>
    </div>
  );
